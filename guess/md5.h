...
#define FF_VEC(a, b, c, d, x, s, t) \
    a = vaddq_u32(a, vaddq_u32(F_NEON(b, c, d), vaddq_u32(x, vdupq_n_u32(t)))); \
    a = ROTATELEFT_NEON(a, s); \
    a = vaddq_u32(a, b);

#define GG_VEC(a, b, c, d, x, s, t) \
    a = vaddq_u32(a, vaddq_u32(G_NEON(b, c, d), vaddq_u32(x, vdupq_n_u32(t)))); \
    a = ROTATELEFT_NEON(a, s); \
    a = vaddq_u32(a, b);

#define HH_VEC(a, b, c, d, x, s, t) \
    a = vaddq_u32(a, vaddq_u32(H_NEON(b, c, d), vaddq_u32(x, vdupq_n_u32(t)))); \
    a = ROTATELEFT_NEON(a, s); \
    a = vaddq_u32(a, b);

#define II_VEC(a, b, c, d, x, s, t) \
    a = vaddq_u32(a, vaddq_u32(I_NEON(b, c, d), vaddq_u32(x, vdupq_n_u32(t)))); \
    a = ROTATELEFT_NEON(a, s); \
    a = vaddq_u32(a, b);
